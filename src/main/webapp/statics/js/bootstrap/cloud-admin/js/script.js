var App = function () {
	...
	var handleBootbox = function () {
		...
		$(".confirm-dialog").click(function(){
			bootbox.confirm("确定操作么?", function(result){});
		});
	...
	/*-----------------------------------------------------------------------------------*/
	/*	Handle Backstretch 修改
	/*-----------------------------------------------------------------------------------*/
	var handleBackstretch = function () {
		 $.backstretch([
		"/Resouce/img/login/1.jpg"
		, "/Resouce/img/login/2.jpg"
		//, "/Resouce/img/login/3.jpg"
		//, "/Resouce/img/login/4.jpg"
	...
	return {
        ...
        init: function () {
			if (App.isPage("datetimepicker")) {
				handleDatePicker(); //Function to handle date
            }
            if (App.isPage("index")) {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="/Resouce/img/loaders/12.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
...
/*-----------------------------------------------------------------------------------*/
function swichMenu() {
    var id = sessionStorage.getItem("menu");
    if (id == null) {
        $("#menu1").css("background-color", "rgba(255, 255, 255, 0.35)");
    }
    $("#" + id).css("background-color", "rgba(255, 255, 255, 0.35)");
...
function blockUI(el, loaderOnTop) {
    lastBlockedUI = el;
    jQuery(el).block({
        message: '<img src="/Resouce/img/loaders/11.gif" align="absmiddle">',
        css: {
            border: 'none',
            padding: '2px',
            backgroundColor: 'none'
